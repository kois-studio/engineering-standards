...
Profiles guide technology selection and architecture for common project shapes. They are defaults, not blind migration mandates. An existing system may remain on another technology when that choice is justified and working; the project should make the exception visible.
