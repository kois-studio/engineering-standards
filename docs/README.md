...
- [Standards](standards/README.md) - cross-project rules for documentation, testing, TypeScript, styling, security, dependencies, CI/CD, operations, APIs, data, and web quality.
